...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/aaiki9/Autoscript-vpn/main/izin > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/aaiki9/Autoscript-vpn/main/izin | grep $MYIP | awk '{print $2}')
